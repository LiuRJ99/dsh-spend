  ...
  try {
    ...
    for await (const text of frameTextsAsync(buffer)) {
      for (const line of text.split("\n")) {
        ...
        // Current DSH persistence packs long assistant/chunk runs into
        // text-chunks/reasoning-chunks/tool-call-chunks rows. Decode those
        // rows before folding so performance timestamps see the same event
        // stream as a live Session snapshot.
